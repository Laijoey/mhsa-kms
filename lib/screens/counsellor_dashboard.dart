                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _SeverityRow(
                                  label: 'Normal',
                                  value: ((_analytics?['severityDistribution']?['Normal'] as num?) ?? 0.0) / 100,
                                ...
                                _SeverityRow(
                                  label: 'Mild',
                                  value: ((_analytics?['severityDistribution']?['Mild'] as num?) ?? 0.0) / 100,
                                  color: const Color(0xFFE2EBE2),
                                  textColor: const Color(0xFF354B0E),
                                ),
                                const SizedBox(height: 16),
                                _SeverityRow(
                                  label: 'Moderate',
                                  value: ((_analytics?['severityDistribution']?['Moderate'] as num?) ?? 0.0) / 100,
                                ...
                                _SeverityRow(
                                  label: 'Severe',
                                  value: ((_analytics?['severityDistribution']?['Severe'] as num?) ?? 0.0) / 100,
                                ...
                                _SeverityRow(
                                  ...
                                  value: ((_analytics?['severityDistribution']?['Extremely Severe'] as num?) ?? 0.0) / 100,
